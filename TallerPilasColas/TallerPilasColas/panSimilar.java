...
public class panSimilar {
    ...
    public static boolean panSimilar(List<String> sandwi1, List<String> sandwi2) {
        Deque<String> d1 = new ArrayDeque<>();
        Deque<String> d2 = new ArrayDeque<>();

        // encolar los elementos
        for (int i = 0; i < sandwi1.size(); i++) {
            d1.addLast(sandwi1.get(i));
        }
        for (int i = 0; i < sandwi2.size(); i++) {
            d2.addLast(sandwi2.get(i));
        }
